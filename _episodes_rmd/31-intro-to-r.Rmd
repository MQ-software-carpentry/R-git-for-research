...
At this stage we want to make sure we have saved our script and tracked changes. Save your script file if you have not done so already. Navigate to the `Git` tab in RStudio. As we have done 
